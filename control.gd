...
# press button, update input label
# add operator functions
# calculate first and second values to create new value
# move to value label once enter is hit
# add other fucntions like delete, 
